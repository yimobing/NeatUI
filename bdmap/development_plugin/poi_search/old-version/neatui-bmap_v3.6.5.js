 ...
 */
 ...
 (function(window) {
    ...
    // 插件版本号
    var VERSION = 'v3.6.5'; // 注：3.6.3 的beta4和beta4-final可用, beta5-7是垃圾版本不可用
    ...
    BaiduPoiSearch.prototype.bindEvents = function() {
        ...
        if (mustChooseBtn) {
            mustChooseBtn.addEventListener('click', function(e) {
                ...
                poiSearch.setDefaultCategories(mustCategories);  // init() 之后才能调用！
            });
        }
     ...
     */
    BaiduPoiSearch.prototype.handleInputDropWord = function(ps_selector_id, ps_selecttor_value) {
